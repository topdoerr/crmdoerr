					...
					<div class="panel-body">
						...
						<div class="btn-group pull-right mleft4 btn-with-tooltip-group" data-toggle="tooltip" data-title="<?php echo _l('si_ts_filter_templates'); ?>" data-original-title="" title="">
							...
							if(!empty($filter_templates))
							{
								...
								{
									echo "<li><a href='timesheet_summary?filter_id=$row[id]'>".($row['is_default']? "<i class='fa fa-star'></i> ":"")."$row[filter_name]</a></li>";
								}
							}
							else
						...
						<a href="timesheet_summary" class=" pull-right btn btn-info mleft4" data-toggle="tooltip" data-title="<?php echo _l('si_ts_filter_new_info'); ?>"><?php echo _l('si_ts_new'); ?></a>
						...
						<div class="row">
							...
							<div class="col-md-2 border-right mtop10 mbot15">
								<div class="checkbox checkbox-success" data-toggle="tooltip" title="" data-original-title="<?php echo _l('si_ts_filter_set_as_default_info'); ?>">
									<input type="checkbox" id="si_ts_is_default" name="is_default" value="1" title="<?php echo _l('si_ts_filter_set_as_default_info'); ?>" <?php echo ($is_default == 1?'checked':'')?>>
									<label for=""><span><?php echo _l('si_ts_filter_set_as_default'); ?></span></label>
								</div>
							</div>
							<!--end set as default-->
							<!--start save filter-->
